package coffee.com.coffeegallery.utils;
...
/**
 * author：caoyamin on 16/4/23 12:35
...
public class ImagePipelineConfigUtils {
    ...
    //小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "MamiCacheSmall";

    //默认图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "MamiCacheDefault";
